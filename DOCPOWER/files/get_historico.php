...
try {
    ...
    $stmt = $conexao->prepare("SELECT id, usuario_id, razao_social, cnpj, data_finalizacao FROM solicitacoes WHERE arquivo = 1 AND usuario_id = :usuario_id");
            ...
            if (is_dir($directory)) {
                ...
                if (count($files) > 2) {
                    ...
                    $a = "
                        ...
                        <h3><a href='baixar.php?solicitacao_id=".$solicitacao["id"]."&arquivo=" . htmlspecialchars(urlencode($filePath)) . "' target='_blank'>Baixar!</a></h3>
                    ";
                } else {
                    $a = " ";
                }
